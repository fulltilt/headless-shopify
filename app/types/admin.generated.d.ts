...
export type GetProductListQuery = { products: { edges: Array<{ node: (
        ...
        & { variants: { edges: Array<{ node: Pick<AdminTypes.ProductVariant, 'id' | 'title' | 'price'> }> }, priceRange: { maxVariantPrice: Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'> }, images: { edges: Array<{ node: Pick<AdminTypes.Image, 'url'> }> } }
      ) }> } };
